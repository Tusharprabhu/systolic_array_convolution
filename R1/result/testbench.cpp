...
int sc_main(int argc, char* argv[]) {
    ...
    // Instantiate modules
    R1_SystolicArray systolic_array("R1_SystolicArray");
    ...
    sc_trace_file* tf = sc_create_vcd_trace_file("r1_systolic_array");
    ...
    // Start simulation
    cout << "Starting R1 systolic array simulation..." << endl;
    sc_start();
